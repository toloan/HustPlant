...
public class Initializer extends Callback {
    ...
    public void onCreate(@NonNull SupportSQLiteDatabase db) {
        ...
        Executors.newSingleThreadScheduledExecutor().execute(new Runnable() {
            ...
            public void run() {
                Plant[] plants = {
                        new Plant(1, new Point(92, 95), "Oak", "Oaks have spirally arranged " +
                                "leaves, with lobate " +
                                "margins" +
                                ...
                                " across the genus.", 0.5f, 0.7f, R.drawable.ic_menu_camera),
                        new Plant(2, new Point(137, 155), "Maple", "Maples are distinguished by " +
                                "opposite leaf " +
                                "arrangement" +
                                ...
                                "unlobed leaves.", 0.2f, 0.8f, R.drawable.ic_menu_gallery),
                        new Plant(3, new Point(227, 120), "Cherry Blossom", "The most popular " +
                                "variety of cherry " +
                                "blossom " +
                                ...
                                "depictions are anachronisms.", 0.4f, 0.6f, R.drawable
                                .ic_menu_manage),
                        new Plant(4, new Point(262, 74), "Hazel", "Hazels have simple, rounded " +
                                "leaves with " +
                                ...
                                " the nut.", 0.15f, 0.25f, R.drawable.ic_menu_send)
                };
